...
export const ru: Record<TranslationKey, string> = {
  ...
  "settings.callProviders.privacy": "Ссылки хранятся только на этом устройстве и не передаются на сервер.",
  "settings.callProviders.useExternal": "Использовать вместо встроенных звонков",
  "settings.callProviders.empty": "Способы не настроены. Добавьте Zoom, Google Meet или другой сервис.",
  "settings.callProviders.add": "Добавить способ",
  "settings.callProviders.edit": "Изменить",
  "settings.callProviders.delete": "Удалить",
  "settings.callProviders.makeDefault": "Сделать по умолчанию",
  "settings.callProviders.isDefault": "По умолчанию",
  "settings.callProviders.kind": "Сервис",
  ...
  "settings.callProviders.setDefaultOnSave": "Использовать по умолчанию",
  ...
  "settings.callProviders.kinds.zoom": "Zoom",
  "settings.callProviders.kinds.google_meet": "Google Meet",
  "settings.callProviders.kinds.jitsi": "Jitsi",
  "settings.callProviders.kinds.custom": "Другое",
