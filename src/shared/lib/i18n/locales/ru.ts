...
export const ru: Record<TranslationKey, string> = {
  ...
  // ── AI-чаты (local-ai) ──
  "ai.newChat": "Новый AI-чат",
  "ai.defaultChatTitle": "Новый чат",
  "ai.emptyState": "Пока нет AI-чатов",
  "ai.emptyStateHint": "Начните новый чат — ответы генерируются на этом устройстве, данные никуда не отправляются",
  "ai.download": "Скачать модель",
  "ai.resumeDownload": "Докачать модель ({percent}%)",
  "ai.update": "Обновить модель",
  "ai.delete": "Удалить модель",
  "ai.deleteConfirm": "Удалить скачанную модель? Позже её можно будет скачать снова.",
  "ai.discardDownload": "Отменить загрузку",
  "ai.discardDownloadConfirm": "Удалить загруженные данные? Модель придётся скачивать заново.",
  "ai.deleting": "Удаление…",
  "ai.pause": "Пауза",
  "ai.resume": "Возобновить",
  "ai.downloadPaused": "Пауза… {percent}%",
  "ai.verifying": "Проверка файла… {percent}%",
  ...
  "ai.downloadErrorGeneric": "Не удалось скачать модель. Проверьте подключение к интернету и нажмите «Докачать».",
  "ai.downloadErrorChecksum": "Скачанный файл повреждён. Попробуйте скачать модель заново.",
  "ai.downloadErrorStorage": "Недостаточно места на устройстве для скачивания модели.",
  ...
  "ai.messageError": "Не удалось сгенерировать ответ",
  "ai.thinking": "Думает…",
  "ai.reasoning": "Ход рассуждений",
  "ai.sendPlaceholder": "Сообщение AI…",
  "ai.send": "Отправить",
  "ai.settingsTitle": "Локальный AI",
  ...
  "settings.showPrivateKey": "Показать приватный ключ",
  "settings.showPrivateKeyConfirm": "Вы действительно хотите посмотреть приватный ключ?",
  "settings.showPrivateKeyYes": "Да",
  "settings.showPrivateKeyNo": "Нет",
  "settings.privateKeyIsPassword": "Этот ключ — ваш пароль! Не потеряйте его и не показывайте никому.",
  "settings.privateKeyImportant": "Важно! Запишите этот ключ для входа. Мы не храним ваши персональные данные. Приватный ключ не может быть восстановлен!",
  "settings.privateKeyLabel": "Приватный ключ",
  "settings.copyPrivateKey": "Скопировать приватный ключ",
  ...
  "notificationsSettings.manageTitle": "Звук и вибрация",
  "notificationsSettings.manageDesc": "Звук, вибрация и важность для каждого типа уведомлений настраиваются в системных настройках.",
  "notificationsSettings.openSystem": "Открыть настройки уведомлений",
  "notificationsSettings.vendorTitle": "Не слышно уведомлений?",
  "notificationsSettings.vendorHint": "Производитель устройства может приглушать уведомления приложений, даже когда звук включён. Откройте системные настройки уведомлений и убедитесь, что звук разрешён для Forta Chat (проверьте также приложение безопасности/батареи).",
  "notificationsSettings.webNote": "Настройки звука уведомлений доступны в мобильном приложении.",
  "interop.bastyonWarning.title": "Установлен Bastyon",
  "interop.bastyonWarning.body": "Forta и Bastyon используют один аккаунт и уведомления. Если запущены оба приложения, звонки и уведомления могут дублироваться — для стабильной работы используйте одно приложение или отключите уведомления о звонках в другом.",
  "interop.bastyonWarning.dismiss": "Понятно",
  "about.loading": "Загрузка...",
  "about.version": "Версия",
  "about.webviewVersion": "Версия WebView",
  "about.androidVersion": "Версия Android",
  "about.androidSdk": "Уровень API",
  "about.device": "Устройство",
  "about.screen": "Экран",
  ...
  "bugReport.descriptionPlaceholder": "Что пошло не так? Шаги для воспроизведения...",
  "bugReport.attachScreenshot": "Прикрепить изображение",
  "bugReport.send": "Отправить",
  "bugReport.sending": "Отправляем...",
  "bugReport.success": "Баг-репорт отправлен. Спасибо!",
  "bugReport.error": "Не удалось отправить. Попробуйте позже.",
  "bugReport.screenshotUploadFailed": "Скриншоты сохранены как текст в репорте",
  "bugReport.subtitle": "Репорт анонимный. Информация об устройстве собирается автоматически.",
  "bugReport.errorLabel": "Ошибка",
  "bugReport.showExamples": "Как написать хороший репорт?",
  "bugReport.hideExamples": "Скрыть примеры",
  "bugReport.examplesTitle": "Примеры хороших репортов:",
  "bugReport.example1": "\u2022 \"Сообщения не отправляются при переключении с Wi-Fi на мобильные данные. Вижу спиннер, но ничего не происходит.\"",
  "bugReport.example2": "\u2022 \"Видеозвонок обрывается через ~30 секунд. Собеседник меня слышит, а я его — нет.\"",
  "bugReport.example3": "\u2022 \"Приложение зависает на 5 секунд при открытии чата с 1000+ сообщениями.\"",
  "bugReport.ctx.placeCall": "Не удалось совершить звонок",
  "bugReport.ctx.answerCall": "Не удалось ответить на входящий звонок",
  "bugReport.ctx.toggleReaction": "Не удалось поставить реакцию на сообщение",
  "bugReport.ctx.editMessage": "Не удалось отредактировать сообщение",
  "bugReport.ctx.deleteMessage": "Не удалось удалить сообщение",
  "bugReport.ctx.sendPoll": "Не удалось создать опрос",
  "bugReport.ctx.votePoll": "Не удалось проголосовать в опросе",
  "bugReport.ctx.endPoll": "Не удалось завершить опрос",
  "bugReport.ctx.voiceRecord": "Не удалось начать запись голосового сообщения",
  ...
  "bugReportStatus.submitError": "Не удалось обновить жалобу. Попробуйте позже.",
  "bugReportStatus.manageTitle": "Мои жалобы",
  "bugReportStatus.manageSubtitle": "Здесь все жалобы, которые вы отправили. Отметьте решённые, чтобы не засорять список, или переоткройте, если проблема вернулась.",
  "bugReportStatus.stateOpen": "В работе",
  "bugReportStatus.stateClosed": "Решена",
  "bugReportStatus.closeBtn": "Проблема решена",
  "bugReportStatus.reopenBtn": "Проблема вернулась",
  "bugReportStatus.closeReasonLabel": "Что помогло? (необязательно)",
  "bugReportStatus.closeReasonPlaceholder": "Например: разобрался сам, не воспроизводится, не актуально",
  "bugReportStatus.closeSubmit": "Отметить решённой",
  "settings.myBugReports": "Мои жалобы",
  ...
  "message.encryptedNotice": "Зашифрованное сообщение",
  "message.retryDecrypt": "Расшифровать",
  "message.encryptedPreview": "🔒 Зашифрованное сообщение",
  ...
  "chatInfo.viewProfile": "Перейти в профиль",
  ...
  "settings.callProviders.how.step2": "В чате нажмите кнопку звонка. Если способов несколько — появится меню выбора; в личном чате в нём остаётся и встроенный звонок Forta.",
  "settings.callProviders.how.step3": "Собеседник получит карточку со ссылкой и кнопкой «Присоединиться», а вы как организатор сразу откроете встречу (если включено ниже).",
  "settings.callProviders.privacy": "Ссылки хранятся только на этом устройстве и никогда не передаются на сервер.",
  "settings.callProviders.behaviour": "Поведение",
  "settings.callProviders.autoOpen": "Открывать встречу сразу при звонке",
  "settings.callProviders.autoOpenHint": "Когда вы начинаете звонок по ссылке, она сразу откроется у вас в браузере (вы — организатор). Если выключить — ссылка только отправится в чат, а присоединиться можно по карточке.",
  "settings.callProviders.yourMethods": "Ваши способы связи",
  "settings.callProviders.empty": "Способы не настроены. Добавьте ссылку на встречу — она появится в выборе при звонке.",
  "settings.callProviders.add": "Добавить способ",
  "settings.callProviders.edit": "Изменить",
  "settings.callProviders.delete": "Удалить",
  "settings.callProviders.label": "Название",
  "settings.callProviders.labelPlaceholder": "Личный Zoom",
  "settings.callProviders.url": "Ссылка",
  "settings.callProviders.urlPlaceholder": "https://zoom.us/j/1234567890",
  "settings.callProviders.save": "Сохранить",
  "settings.callProviders.cancel": "Отмена",
  ...
  "desktopSettings.updates": "Обновления",
  "desktopSettings.updatesDesc": "Forta Chat может автоматически скачивать и устанавливать новые desktop-версии, когда релиз опубликован.",
  "desktopSettings.checkForUpdates": "Проверить обновления",
  "desktopSettings.restartAndInstall": "Перезапустить и установить",
  "desktopSettings.updateIdle": "Проверка обновлений ещё не выполнялась.",
  "desktopSettings.updateChecking": "Проверка обновлений…",
  "desktopSettings.updateAvailable": "Доступно обновление {version} — загрузка начнётся автоматически.",
  "desktopSettings.updateUpToDate": "У вас актуальная версия ({version}).",
  "desktopSettings.updateDownloading": "Загрузка обновления… {percent}%",
  "desktopSettings.updateReady": "Обновление {version} готово. Перезапустите, чтобы установить.",
  "desktopSettings.updateError": "Не удалось проверить обновления: {message}",
  "desktopSettings.updateDisabledHint": "Автообновление отключено в dev-сборках.",
  ...
  "tor.modeNever": "Никогда",
  "tor.modeAuto": "Авто",
  "tor.modeAlways": "Всегда",
  "tor.modeNeverHint": "Весь трафик идёт напрямую — без Tor.",
  "tor.modeAutoHint": "Tor используется только если хост недоступен напрямую.",
  "tor.modeAlwaysHint": "Весь трафик через Tor (кроме CDN из белого списка).",
  "tor.status": "Статус",
  "tor.statusHint": "Текущее состояние Tor и выходной IP.",
  ...
  "tor.shieldDisabled": "Состояние Tor — выключен",
  "tor.shieldLoading": "Состояние Tor — загрузка",
  "tor.shieldStarting": "Модуль Tor запускается",
  "tor.shieldRunning": "Модуль Tor работает",
  "tor.stats": "Статистика сети",
  "tor.statsHint": "Трафик через Tor и напрямую.",
  "tor.statCurrentDirect": "Текущий, прямой",
  "tor.statCurrentTor": "Текущий, Tor",
  "tor.statTotalDirect": "Всего, прямой",
  "tor.statTotalTor": "Всего, Tor",
  ...
  "register.cancelRegistration": "Отменить регистрацию",
  "register.cancelConfirmTitle": "Отменить регистрацию?",
  "register.cancelConfirmHint": "Seed-фраза уже была показана — сохраните её, если ещё не сделали. PKOIN или транзакция профиля могут уже быть в блокчейне. Локальные данные этого аккаунта будут удалены.",
  "register.cancelConfirmAction": "Отменить регистрацию",
  "register.cancelConfirmDismiss": "Продолжить ожидание",
  ...
  "download.downloadFor": "Скачать для {platform}",
  "download.allPlatforms": "Все платформы",
  "download.getTheApp": "Скачайте приложение",
  "download.getTheAppDesc": "Установите Forta Chat на устройство — Windows, macOS, Linux или Android.",
  ...
  // ── Утилитарная страница загрузок ──
  "apps.title": "Скачать Forta Chat",
  "apps.subtitle": "Установите приложение для своей системы. Прямые загрузки с GitHub Releases.",
  "apps.loadingVersion": "Загружаем последнюю версию…",
  "apps.versionFallback": "Последний релиз — GitHub",
  "apps.recommended": "Рекомендуем для вашего устройства",
  "apps.yourDevice": "Ваше устройство",
  "apps.pickPlatform": "Не удалось определить ОС — выберите платформу ниже.",
  "apps.allPlatforms": "Все платформы",
  "apps.download": "Загрузить",
  "apps.googlePlay": "Google Play",
  "apps.githubReleases": "Все релизы на GitHub",
  "apps.aboutProduct": "О продукте",
  "apps.platform.windows": "Windows",
  "apps.platform.macos": "macOS",
  "apps.platform.linux": "Linux",
  "apps.platform.android": "Android",
