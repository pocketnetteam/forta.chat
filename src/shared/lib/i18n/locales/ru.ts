...
export const ru: Record<TranslationKey, string> = {
  ...
  "bugReportStatus.title": "Твои жалобы",
  "bugReportStatus.subtitle": "Разработчик отметил эти жалобы как решённые. Всё действительно исправилось?",
  "bugReportStatus.resolvedBtn": "Решено",
  "bugReportStatus.notResolvedBtn": "Всё ещё баг",
  "bugReportStatus.viewOnGithub": "Открыть на GitHub",
  "bugReportStatus.laterBtn": "Позже",
  ...
  "bugReportStatus.manageSubtitle": "Все твои жалобы. Можешь закрыть открытую, если проблема больше не актуальна, или переоткрыть закрытую.",
  "bugReportStatus.stateOpen": "Открыта",
  "bugReportStatus.stateClosed": "Закрыта",
  "bugReportStatus.closeBtn": "Закрыть",
  "bugReportStatus.reopenBtn": "Открыть снова",
  "bugReportStatus.closeReasonLabel": "Почему закрываешь? (необязательно)",
  "bugReportStatus.closeReasonPlaceholder": "Например: разобрался сам, не воспроизводится, не актуально",
  "bugReportStatus.closeSubmit": "Закрыть жалобу",
  "bugReportStatus.emptyManage": "Пока нет отправленных жалоб.",
