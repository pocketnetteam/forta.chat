...
export const ru: Record<TranslationKey, string> = {
  ...
  "settings.callProviders.description": "Свои ссылки для звонков (Zoom, Meet, Jitsi — любая). Хранятся только на этом устройстве и не передаются на сервер. При звонке можно отправить ссылку в чат вместо встроенного звонка.",
