export const en = {
  ...
  "settings.callProviders.description": "Your own meeting links (Zoom, Meet, Jitsi — anything). Stored on this device only, never sent to the server. When you call, you can send a link into the chat instead of placing a built-in call.",
