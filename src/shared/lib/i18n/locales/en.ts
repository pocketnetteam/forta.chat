export const en = {
  ...
  "ai.defaultChatTitle": "New chat",
  "ai.emptyState": "No AI chats yet",
  "ai.emptyStateHint": "Start a new chat — replies are generated on this device, no data leaves your phone",
  "ai.download": "Download model",
  "ai.resumeDownload": "Resume download ({percent}%)",
  "ai.update": "Update model",
  ...
  "ai.messageError": "Couldn't generate a response",
  "ai.thinking": "Thinking…",
  "ai.reasoning": "Reasoning",
  "ai.sendPlaceholder": "Message the AI…",
  "ai.send": "Send",
  "ai.settingsTitle": "Local AI",
  ...
  "settings.showPrivateKey": "Show private key",
  "settings.showPrivateKeyConfirm": "Are you sure you want to view your private key?",
  "settings.showPrivateKeyYes": "Yes",
  "settings.showPrivateKeyNo": "No",
  "settings.privateKeyIsPassword": "This key is your password! Do not lose it and do not show it to anyone.",
  "settings.privateKeyImportant": "Important! Write down this key to sign in. We do not store your personal data. The private key cannot be recovered!",
  "settings.privateKeyLabel": "Private key",
  "settings.copyPrivateKey": "Copy private key",
  ...
  "desktopSettings.updates": "Updates",
  "desktopSettings.updatesDesc": "Forta Chat can download and install new desktop versions automatically when a release is published.",
  "desktopSettings.checkForUpdates": "Check for updates",
  "desktopSettings.restartAndInstall": "Restart and install",
  "desktopSettings.updateIdle": "No update check yet.",
  "desktopSettings.updateChecking": "Checking for updates…",
  "desktopSettings.updateAvailable": "Update {version} is available and will download automatically.",
  "desktopSettings.updateUpToDate": "You are up to date ({version}).",
  "desktopSettings.updateDownloading": "Downloading update… {percent}%",
  "desktopSettings.updateReady": "Update {version} is ready. Restart to install.",
  "desktopSettings.updateError": "Update check failed: {message}",
  "desktopSettings.updateDisabledHint": "Auto-update is disabled in development builds.",
  "tor.useTor": "Use Tor",
  ...
  "register.cancelConfirmTitle": "Cancel registration?",
  "register.cancelConfirmHint": "Your seed phrase was already shown — save it if you haven't. PKOIN or a profile transaction may already be on the blockchain. Local data for this account will be deleted.",
  "register.cancelConfirmAction": "Cancel registration",
  "register.cancelConfirmDismiss": "Keep waiting",
  ...
  "download.downloadFor": "Download for {platform}",
  "download.allPlatforms": "All platforms",
  "download.getTheApp": "Get the app",
  "download.getTheAppDesc": "Install Forta Chat on your device — Windows, macOS, Linux, or Android.",
  ...
  // ── Apps download utility page ──
  "apps.title": "Download Forta Chat",
  "apps.subtitle": "Install the app for your system. Direct downloads from GitHub Releases.",
  "apps.loadingVersion": "Loading latest version…",
  "apps.versionFallback": "Latest release — GitHub",
  "apps.recommended": "Recommended for your device",
  "apps.yourDevice": "Your device",
  "apps.pickPlatform": "We could not detect your OS — pick a platform below.",
  "apps.allPlatforms": "All platforms",
  "apps.download": "Download",
  "apps.googlePlay": "Google Play",
  "apps.githubReleases": "All releases on GitHub",
  "apps.aboutProduct": "About",
