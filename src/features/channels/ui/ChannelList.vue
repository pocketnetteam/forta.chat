    ...
    >
      <div v-for="i in 6" :key="i" class="flex items-center gap-3 px-3 py-2.5">
        ...
        <div class="min-w-0 flex-1 space-y-1.5">
          <div class="h-3.5 w-24 shrink-0 contain-strict animate-pulse rounded bg-neutral-grad-2" />
          <div
            class="h-3 shrink-0 contain-strict animate-pulse rounded bg-neutral-grad-2"
