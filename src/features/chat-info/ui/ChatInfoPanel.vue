          ...
          <div v-if="screen === 'main'" class="flex-1 overflow-y-auto">
            ...
            <div class="flex flex-col items-center gap-3 p-6">
              ...
              >
                ...
                >
                  <div v-if="uploadingAvatar" class="h-6 w-6 shrink-0 contain-strict animate-spin rounded-full border-2 border-white border-t-transparent" />
              ...
              <div class="text-center">
                <h2 v-if="isUnresolvedName(roomDisplayName)" class="mx-auto h-5 w-32 shrink-0 contain-strict animate-pulse rounded bg-neutral-grad-2" />
              ...
              <div v-if="showAddMember" class="mb-3">
                ...
                <div class="max-h-[200px] overflow-y-auto">
                  <div v-if="addIsSearching" class="flex justify-center py-2">
                    <div class="h-5 w-5 shrink-0 contain-strict animate-spin rounded-full border-2 border-color-bg-ac border-t-transparent" />
                  </div>
                  <button
