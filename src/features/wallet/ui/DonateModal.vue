      ...
      <div class="flex flex-col gap-2">
        ...
        >
          <span v-if="feesLoading" class="inline-flex items-center gap-2">
            <span class="contain-strict inline-block h-4 w-4 animate-spin rounded-full border-2 border-current border-t-transparent" />
        ...
        >
          <span v-if="sending" class="inline-flex items-center gap-2">
            <span class="contain-strict inline-block h-4 w-4 animate-spin rounded-full border-2 border-white border-t-transparent" />
            {{ t("wallet.send") }}
          </span>
